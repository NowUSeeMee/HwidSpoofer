...
- Tested on **x64 Windows 11 Pro**:
  - Version 21H2 (Build 22000)
  - Version 22H2 (Build 22621)
  - Version 23H2 (Build 22631)
  - Version 24H2 (Build 26100)
- **Windows 11 Pro Enhancements**:
  - TPM 2.0 registry spoofing
  - VBS/HVCI telemetry cleanup
  - Microsoft Defender HWID tracking cleanup
  - Microsoft Edge browser tracking cleanup
  - Xbox Game Bar / GamingServices cleanup
  - EA Desktop (Origin replacement) support
  - Windows 11 Widgets/Feeds tracking cleanup
  - DPI-aware GUI rendering
  - Software vertex processing fallback for D3D9
